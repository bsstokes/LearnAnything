...
public final class RuntimeTypeAdapter<T> implements JsonSerializer<T>, JsonDeserializer<T> {
    ...
    private RuntimeTypeAdapter(Class<?> baseType, String typeFieldName) {
        this(baseType, null, typeFieldName);
    }

    private RuntimeTypeAdapter(Class<?> baseType, Class<?> unknownType, String typeFieldName) {
    ...
    public static <T> RuntimeTypeAdapter<T> create(Class<T> c) {
        return create(c, null, "type");
    }

    public static <T> RuntimeTypeAdapter<T> create(Class<T> c, Class<? extends T> u) {
        return create(c, u, "type");
    }
     ...
     */
    public static <T> RuntimeTypeAdapter<T> create(Class<T> c, Class<? extends T> u, String typeFieldName) {
        return new RuntimeTypeAdapter<T>(c, u, typeFieldName);
    }
